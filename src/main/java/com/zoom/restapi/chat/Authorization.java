...
public class Authorization {
    ...
    public static void authorizeRefreshToken() throws Exception {
    ...
    public static String authorizeAuthCode(String authCode) throws Exception {
        BufferedReader reader;
        String line;
        StringBuffer responseContent = new StringBuffer();
        try {
            URL url = new URL("https://zoom.us/oauth/token?grant_type=authorization_code&code=" + authCode + "&redirect_uri=http://zoomchat-env.eba-qwm3mxqm.us-west-1.elasticbeanstalk.com/zoomOAuth");
            connection = (HttpURLConnection) url.openConnection();
